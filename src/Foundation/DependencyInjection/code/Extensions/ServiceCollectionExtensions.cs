...
namespace Hackathon.Foundation.DependencyInjection.Extensions
{
    using System;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static T Get<T>() => (T)ServiceLocator.ServiceProvider.GetService(typeof(T));

        public static object Get(Type t) => ServiceLocator.ServiceProvider.GetService(t);
        ...
        public static void AddMvcControllersInCurrentAssembly(this IServiceCollection collection)
        {
            AddMvcControllers(collection, Assembly.GetCallingAssembly());
        }
